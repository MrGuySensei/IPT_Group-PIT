...
from .profile_sync import sync_profile_borrow_stats
...
class BorrowRecordViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if request.user.is_authenticated:
            ...
            payload.setdefault('borrower_email', request.user.email)
            payload.setdefault('borrower_name', display_name or request.user.username)
        ...
        sync_profile_borrow_stats(record.borrower_email)
