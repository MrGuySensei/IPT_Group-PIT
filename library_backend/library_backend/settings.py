...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-library-dev-key-12345')
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'library_backend' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# ─── Database ───────────────────────────────────────────────────────────────
# Uses PostgreSQL on production (DATABASE_URL env var), SQLite on dev
...
DEFAULT_FROM_EMAIL = os.environ.get(
    'DEFAULT_FROM_EMAIL',
    f'Library System <{EMAIL_HOST_USER}>' if EMAIL_HOST_USER else 'Library System <noreply@library.com>',
)
